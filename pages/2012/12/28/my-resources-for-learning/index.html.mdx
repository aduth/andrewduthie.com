...
export const title = 'My Resources for Learning';
export const datePublished = new Date('2012-12-28 00:00:00');
export const description =
	"To be a resourceful developer, it's important to keep up with new trends and current best practices to be applied in our own projects. In this article, I share my current sources of useful information.";
