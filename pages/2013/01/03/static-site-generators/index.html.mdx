...
export const title = 'Static Site Generators';
export const datePublished = new Date('2013-01-03 00:00:00');
export const description =
	'An overview of static site generators, including purpose, benefits, and popular options.';
