...
export const datePublished = new Date('2013-01-15 00:00:00');
export const description =
	'A look at RequireJS for JavaScript module loading and dependency management';
...
define(['meat', 'potatoes'], function (meat, potatoes) {
...
require(['dinner'], function (dinner) {
